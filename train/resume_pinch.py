...
RUN_NAME = "ppo_allegro_pinch_lift_v3"
...
BASE_MODEL = "checkpoints/ppo_allegro_grasp_lift_v2/ppo_allegro_grasp_lift_v2_125000_steps.zip"
BASE_VECNORM = "checkpoints/ppo_allegro_grasp_lift_v2/ppo_allegro_grasp_lift_v2_vecnormalize_125000_steps.pkl"
...
model = PPO.load(BASE_MODEL, env=train_env, device="auto")
...
print("===== RESUME PINCH TRAINING START =====")
...
print("===== RESUME PINCH TRAINING DONE =====")
