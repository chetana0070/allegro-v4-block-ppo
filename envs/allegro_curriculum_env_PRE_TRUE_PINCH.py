...
class AllegroBlockEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        if self.stage == 2:
            # Thumb-first curriculum spawn: near thumb, not intersecting index/middle.
    ...
    def step(self, action):
        ...
        if self.stage == 2:
            ...
            # Thumb-first stage.
            # Do not reward generic nearest-finger touch too much.
            ...
            # No generic touch reward in thumb-first stage.
            # Only thumb contact matters.
            if thumb_contact:
                reward += 15.0
